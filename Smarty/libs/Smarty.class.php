...
class Smarty
{
    ...
    var $template_dir_default    =  'templates';
        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $params['resource_name'])) {
                ...
                foreach ((array)$params['resource_base_path'] as $_curr_path) {
                    ...
                    $_fullpath_default = $this->template_dir_default . DIRECTORY_SEPARATOR . $params['resource_name'];
                    if (file_exists($_fullpath) && is_file($_fullpath)) {
                        $params['resource_name'] = $_fullpath;
                        return true;
                    }
					elseif (file_exists($_fullpath_default) && is_file($_fullpath_default)) {
                        $params['resource_name'] = $_fullpath_default;
                        return true;
                    }
