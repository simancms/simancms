...
<tr>
<td width="50%">{if $_settings.use_email_as_login neq "1"}{$lang.login_str}{else}{$lang.common.email}{/if}</td><td width="50%"><input type="text" name="p_login" value="{$modules[$index].user_login}"></td>
</tr>
<tr>
...
<tr>
<td>{$lang.email}</td><td><input type="text" name="p_email" value="{$modules[$index].user_email}"><td>
</tr>
{/if}
<tr>
<td>{$lang.secret_question}</td><td><input type="text" name="p_question" value="{$modules[$index].user_question}"></td>
</tr>
<tr>
<td>{$lang.secret_answer_question}</td><td><input type="text" name="p_answer" value="{$modules[$index].user_answer}"></td>
</tr>
