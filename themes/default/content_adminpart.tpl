...
{if $modules[$index].mode eq "postadd"}
{include file="block_begin.tpl"}
{$lang.add_content_successful}
...
{include file="block_begin.tpl"}
{$lang.edit_content_successful}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}

{if $modules[$index].mode eq "postdelete"}
{include file="block_begin.tpl"}
{$lang.delete_content_successful}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}

{if $modules[$index].mode eq "postaddctg"}
{include file="block_begin.tpl"}
{$lang.add_content_category_successful}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}

{if $modules[$index].mode eq "posteditctg"}
{include file="block_begin.tpl"}
{$lang.edit_content_category_successful}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}

{if $modules[$index].mode eq "postdeletectg"}
{include file="block_begin.tpl"}
{$lang.delete_content_category_successful}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}

{if $modules[$index].mode eq "exchange"}
{include file="block_begin.tpl"}
{include file="refresh.tpl"}
{include file="block_end.tpl"}
{/if}
